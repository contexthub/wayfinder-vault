...
- (void)noBeaconsOnServer:(NSNotification *)notification {
    NSString *message = [NSString stringWithFormat:@"There are no beacons with the tag \"%@\" on the server", WFBeaconTag];
    [[[UIAlertView alloc] initWithTitle:@"Wayfinder" message:message delegate:nil cancelButtonTitle:@"Ok" otherButtonTitles: nil] show];
